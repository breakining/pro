 ...
 * @description: ???
 * @author: ghwei
 * @version: 1.0 2020/9/18 11:01
 */

import com.ghw.system.enums.ErrorCode;
import com.ghw.system.exceptions.FastDFSException;
import com.ghw.system.param.FileResponseData;
import com.ghw.system.util.FastDFSClient;
import com.ghw.system.util.FileCheck;
...
@PropertySource(value = "classpath:config/fastdfs.properties", encoding = "utf-8")
public class FastDfsObjectController {
