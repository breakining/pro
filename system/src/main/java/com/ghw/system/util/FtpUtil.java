...
public class FtpUtil {
     ...
     * @throws IOException
     */
    public static String pictureUploadByConfig(FtpProperties ftpConfig, String picNewName, String picSavePath, InputStream inputStream) throws IOException {
